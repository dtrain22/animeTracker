...
class AccessTokenRepository(
    ...
    fun getAccessToken(code:String, _accessToken:MutableLiveData<String>) {
        if(accessTokenObject.accessToken != null) {
            _accessToken.postValue(accessTokenObject.accessToken)
        } else {
            try {
